...
<body>
    <div class="kolomkanan">
        <div class="mx-auto">
            ...
            <div class="card p-3 mb-5 text-center">
                ...
                Silakan klik menu Absen untuk mulai melakukan absensi. Pastikan akses lokasi sudah diizinkan ya.
                </div>
                ...
                <div class="mb-3 fs-small">
                    <span class="d-block"><i class="bi-geo-alt text-success"></i> <a class="text-success"
                            href="https://maps.app.goo.gl/rGTa25zp5x7zDn7YA" target="_blank">Lokasi Kantor</a>: <b
                            id="my-location">belum terdeteksi</b></span>
                </div>
                <div class="mb-3 fs-small">
                    <span class="d-block">
                        Lokasi Anda: <b id="your-location">belum terdeteksi</b> - <button type="button"
                            class="btn btn-sm" style="background-color: #5F860C; border-color: #5F860C;" onclick="showModalMap()">Lihat</button></span>
                    ...
                    <div class="item">
                        <a href="absen_keluar.php">
                            <div class="button-container btn-outline-biru">
                                ...
                                <div class="button-text absen-keluar">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="simpan" value="Simpan" class="btn" style="background-color: #5F860C; border-color: #5F860C;" />
                    </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        window.addEventListener("load", () => {
            ...
            const latSekolah = <?php echo $latSekolah ?>; // Latitude 
            const longSekolah = <?php echo $longSekolah ?>; // Longitude 
            myLocation.innerText = "Kemenag, karawang.";
