            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="?op=simpan" method="POST">
                        <div class="mb-3">
                            <label for="editNama" class="form-label">Nama Sekolah</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="?op=tambah" method="POST">
                        <div class="mb-3">
                            <label for="tambahNama" class="form-label">Nama Sekolah</label>
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="d-flex align-items-center">Data Sekolah</div>
                <a data-bs-toggle="modal" data-bs-target="#tambahModal">
                    <button type="button" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff; ">Tambah Sekolah</button>
                </a>
            </div>
            <div class="card-body">
                <table class="table">
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a id="iniEditModal" data-bs-toggle="modal" data-bs-target="#editModal"
                                        ...
                                        <button type="button" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff;">Edit</button>
                                    </a>
