...
<a href="beranda" style="margin-left:2px; color:black;text-decoration:none"> <strong style="margin-top:22px;"> ADMIN - KEMENAG</strong> </a>
</nav>
</header>
</div>
    ...
    <ul>
        <li class="list';
                        if ($current_page == "beranda.php") {echo " active";}
        echo '">
            <b></b>
            <b></b>
