                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-text">Jarak maksimal pengguna.</div>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-text">Latitude Kemanag. Kamu bisa mengambilnya dari <i>maps.google.com</i>.
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-text">Longitude Kemenag. Kamu bisa mengambilnya dari
                                <i>maps.google.com</i>.
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10 d-flex align-items-center">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" style="background-color: #5F860C; border-color: #5F860C;"
                    ...
                    <div class="col-12">
                        <input type="submit" name="simpan" value="Simpan" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff;" />
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card" style="margin-bottom:50px">
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="col-12">
                        <input type="submit" name="submit" value="Simpan" class="btn" style="background-color: #5F860C; border-color: #5F860C; color : #fff;" />
                    </div>
                </form>
            </div>
        </div>
