                ...
                <div class="modal-body">
                    <form action="?op=simpan" method="POST">
                        <div class="mb-3 d-none">
                            <label for="editNip" class="form-label">Nrg</label>
                        ...
                        <button type="submit" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff;">Simpan Perubahan</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="?op=tambah" method="POST">
                        <div class="mb-3">
                            <label for="tambahNip" class="form-label">Nrg</label>
                        ...
                        <button type="submit" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff;">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a data-bs-toggle="modal" data-bs-target="#tambahModal">
                    <button type="button" class="btn" style="background-color: #5F860C; border-color: #5F860C; color: #fff;">Tambah Pengguna</button>
                </a>
            </div>
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a id="iniEditModal" data-bs-toggle="modal" data-bs-target="#editModal"
                                        ...
                                        <button type="button" class="btn btn-sm" style="background-color: #5F860C; border-color: #5F860C; color: #fff;">Edit</button>
                                    </a>
                                    <button type='button'
