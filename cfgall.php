...
<a href="login.php" style="margin-left:8px">ABSENSI GURU PENDIDIKAN AGAMAA ISLAM</a>
</nav>
</header>
</div>
...
<span itemprop="name">Logout</span>
    ...
    <ul>
            ...
            <b></b>
            <b></b>
            <a href="#" data-text="AGAPIS">
                <span class="icon mb-5"><i class="bi"><img class="icon" src="../assets/img/logo_departemen_agama.png" /></i></span>
                <span class="title">AGAPIS</span>
            </a>
        </li>
...
// Prevent common shortcuts for accessing "View Source" or Developer Tools
document.addEventListener('keydown', function(event) {
    // Block F12
    if (event.key === 'F12') {
        event.preventDefault();
        alert('Akses ke Developer Tools tidak diizinkan!');
    }
    ...
    if (event.ctrlKey && event.key === 'u') {
        event.preventDefault();
        alert('Akses ke View Source tidak diizinkan!');
    }

    // Block Ctrl+S (Save Page)
    if (event.ctrlKey && event.key === 's') {
        event.preventDefault();
        alert('Akses untuk menyimpan halaman tidak diizinkan!');
    }

    // Block Ctrl+Shift+C (Developer Tools - Elements tab)
    ...
    if (event.ctrlKey && event.key === 'p') {
        event.preventDefault();
        alert('Akses untuk mencetak halaman tidak diizinkan!');
    }
});
</script>