                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nip" name="nip" value="<?php echo  $jabatan ?>"
                                    disabled>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="nip" name="nip" value="<?php echo  $penempatan ?>"
                            disabled>
                                </select>
                            </div>
                        </div>
            ...
            <div class="card" style="margin-bottom:50px">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="col-12">
                            <input type="submit" name="submit" value="Simpan" class="btn" style="background-color: #5F860C; border-color: #5F860C;" />
                        </div>
                    </form>
                </div>
            </div>
