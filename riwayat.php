        ...
        <div class="mx-auto">
            ...
            <div class="card p-3" style="margin-bottom:50px">
                ...
                <form method="get" action="">
                    ...
                    <button type="submit" class="btn" style="background-color: #5F860C; border-color: #5F860C;">Tampilkan</button>
          ...
          ORDER BY absen.id_absen DESC";
                                ...
                                if (!empty($latlong)) {
                                    echo '<td class="text-center"><button type="button" class="tmlokasi btn btn-sm" onclick="showModalMap(\'' . $latlong . '\')" style="background-color: #5F860C; border-color: #5F860C;">Lihat</button></td>';
                                } else {
                                    echo '<td></td>';
                                }
                                echo '</tr>';
